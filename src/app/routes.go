...
import (
	...
	"github.com/auenc/personal-site/src/projects/actions"
	"github.com/fragmenta/fragmenta-cms/src/posts/actions"
	"github.com/fragmenta/router"

	"github.com/auenc/personal-site/src/pages/actions"
...
func setupRoutes(r *router.Router) {
	...
	//Standard REST handlers for projects
	r.Add("/projects", projectactions.HandleIndex)
	r.Add("/projects/dashboard", projectactions.HandleDashboard)
	r.Add("/projects/create", projectactions.HandleCreateShow)
	r.Add("/projects/create", projectactions.HandleCreate).Post()
	r.Add("/projects/{id:[a-z0-9]+}/update", projectactions.HandleUpdateShow)
	r.Add("/projects/{id:[a-z0-9]+}/update", projectactions.HandleUpdate).Post()
	r.Add("/projects/{id:[a-z0-9]+}/destroy", projectactions.HandleDestroy).Post()
	r.Add("/projects/{id:[a-z0-9]+}", projectactions.HandleShow)
